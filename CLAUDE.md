...
**Starter domains:** *(auto-filled during bootstrap step 2/3 from actual folder structure, route files, and schema — e.g., real domains like "Auth," "Billing," whatever the project's actual core features are, derived from discovery, not assumed from a generic SaaS template.)*
